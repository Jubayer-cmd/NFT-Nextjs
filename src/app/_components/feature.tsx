...
export default function Feature() {
  return (
    <div className="mt-20 py-10 bg-[#D9E0EC33] p-2">
      <p className='font-mono text-3xl font-semibold'>Collection Featured NFTs</p>
      <div className="grid grid-cols-3 mt-10 gap-10">
        <div>
          ...
          <p className='font-sans text-lg font-semibold my-3'>Amazing Collection</p>
          <div className='flex justify-between items-center'>
            <div className='flex items-center'>
            <Image src={profile} alt='collection' className='mr-2' />
            <p className='font-sans font-bold'>by Arkhan</p>
            </div>
            <button className='border-2 border-[#2639ED] py-2 px-3 rounded-full text-[#2639ED] font-sans text-xs hover:bg-[#2639ED] hover:text-white'>Total 54 Items</button>
          </div>
        </div>
        <div>
          <div className='flex'>
